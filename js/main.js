!(function (t) {
  ...
  function (t, n, r) {
    ...
    if (r(7)) {
      var e = r(29),
        ...
        Gt = function (t, n, r) {
          return !(Wt(t, (n = m(n, !0))) && S(r) && x(r, 'value')) ||
            x(r, 'get') ||
            x(r, 'set') ||
            r.configurable ||
            ...
            ? ((p = r(function (t, r, e, i) {
                ...
                if (S(r)) {
                  if (
                    ...
                    return xt in r ? Ft(p, r) : jt.call(p, r);
                  (o = r), (v = Et(e, n));
                  var y = r.byteLength;
                  if (void 0 === i) {
    ...
    ((n = t.exports = function (t, n, r, l, h) {
      ...
      if (o(y)) {
        for (v = c(t.length); v > x; x++)
          if ((g = n ? m(u((p = t[x]))[0], p[1]) : m(t[x])) === f || g === s)
            return g;
      } else
  ...
  function (t, n, r) {
    ...
    t.exports = function (t, n, r, d, g, y) {
      ...
      if (
        ...
        (x = d.getConstructor(n, t, g, b)), u(x.prototype, r), (c.NEED = !0);
      return (
        v(x, t),
        (w[t] = x),
        i(i.G + i.W + i.F * (x != m), w),
  ...
  function (t, n, r) {
    ...
    function V(t, n, r, e, i, o) {
      ...
      for (var c = t[A]._b, a = u + t[I], f = e(+i), s = 0; s < n; s++)
        c[a + s] = f[o ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
  ...
  function (t, n, r) {
    ...
    var e,
      ...
      x = (t.exports = r(61)('WeakMap', y, m, f, !0, !0));
    h &&
      v &&
  ...
  function (t, n, r) {
    'use strict';
    (function (t) {
      if ((r(131), r(328), r(329), t._babelPolyfill))
  ...
  function (t, n, r) {
    ...
    var e = r(2),
      ...
      H = function (t) {
        ...
        return (
          !(this === V && i(G, t) && !i(U, t)) &&
          (!(n || !i(this, t) || !i(G, t) || (i(this, L) && this[L][t])) || n)
        );
      },
      Z = function (t, n) {
        if (((t = S(t)), (n = w(n, !0)), t !== V || !i(G, n) || i(U, n))) {
          var r = j(t, n);
          return (
            !r || !i(G, n) || (i(t, L) && t[L][n]) || (r.enumerable = !0), r
          );
        }
      },
      Q = function (t) {
        for (var n, r = N(S(t)), e = [], o = 0; r.length > o; )
          i(G, (n = r[o++])) || n == L || n == a || e.push(n);
        return e;
      },
      tt = function (t) {
        for (
          var n, r = t === V, e = N(r ? U : S(t)), o = [], u = 0;
          e.length > u;
    ...
    B ||
      (c(
        (R = function () {
          ...
          return o && Y && $(V, t, { configurable: !0, set: n }), J(t);
        }).prototype,
        'toString',
        function () {
          return this._k;
    ...
    for (
      ...
      v(nt[rt++]);
    for (var et = A(v.store), it = 0; et.length > it; ) d(et[it++]);
    u(u.S + u.F * !B, 'Symbol', {
      for: function (t) {
        ...
        [
          ...
          function (t, n) {
            ...
            for (var b = 0, S = 0, w = []; S < h.length; ) {
              ...
              if (
                null === E ||
                (_ = l(c(m.lastIndex + (p ? 0 : S)), h.length)) === b
              )
                S = u(h, S, g);
              else {
  ...
  function (t, n, r) {
    r(330), (t.exports = r(18).RegExp.escape);
  },
  function (t, n, r) {
    var e = r(0),
      i = r(331)(/[\\^$*+?.()|[\]{}]/g, '\\$&');
              ...
              switch ((t.prev = t.next)) {
                ...
                case 2:
                  return t.abrupt(
                    'return',
                    Math.random() > 0.2
                      ? { msg: 'User registration success', id: 1 }
                      : u('User registration error')
                  );
                case 3:
                case 'end':
                  return t.stop();
            ...
            for (;;)
              switch ((t.prev = t.next)) {
                case 0:
                  return (t.next = 2), c();
                case 2:
                  return (n = t.sent), (t.next = 5), f(n.id);
                case 5:
                  return (r = t.sent), (t.next = 8), l(r.token);
                case 8:
